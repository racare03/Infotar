...
public class MovimientosPage {
	...
	//cosntructor
	public MovimientosPage(WebDriver driver) {
		this.driver = driver;
	}
	...
	//Hacer click en el botón Informe
		...
		public void selectFechaOpDesde(String fecha) {
			...
			//((JavascriptExecutor)driver).executeScript ("document.getElementById('fechaOpeHasta').removeAttribute('readonly',0);");
			fechaDesde.clear();
		...
		public void ponerNombreFiltro(String nombreFiltro) {
			WebDriverWait wait = new WebDriverWait(driver,10);
			wait.until(ExpectedConditions.presenceOfElementLocated(inputNuevoFiltro));
