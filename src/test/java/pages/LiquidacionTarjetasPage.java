...
public class LiquidacionTarjetasPage {
	...
	By fechaDesdeBy = By.id("fechaLiquidDesde");
	By fechaHastaBy = By.id("fechaLiquidHasta");
	By movimientoDetalle = By.xpath("//*[@id=\"tb-liq-filtradas\"]/tbody/tr/td");
	//By movimientoDetalle = By.xpath("//*[@id=\"tb-movs-detallados\"]/tbody/tr[1]/td[4]");
	By botonLimpiar = By.id("bClear");
	By botonVerFiltros = By.id("bVerFiltros");
	//By ultimoFiltro = By.cssSelector("#filterTable > tbody > tr:last-child > td:nth-child(1)");
	By primerElemento = By.cssSelector("#filterTable > tbody > tr:nth-child(1) > td:nth-child(1)");
	...
	By mensajeTextoGuardado = By.xpath("//*[@id=\"text-dialog\"]/p");
	By mensajeSinNombre = By.xpath("//*[@id=\"text-dialog\"]/p");
	
	public LiquidacionTarjetasPage(WebDriver driver) {
		this.driver = driver;
	}
	...
	//Hacer click en el botón Informe
			...
			public void selectFechaOpDesde(String fecha) {
				...
				public String getMovimientos() {
					WebDriverWait wait = new WebDriverWait(driver,10);
					wait.until(ExpectedConditions.textToBe(movimientoDetalle,"No se encontraron resultados"));
